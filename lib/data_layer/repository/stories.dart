...
class Stories {
  static List<StoryModel> stories = [
    ...
    StoryModel(
        ...
        text: 'Hana Montana',
        profileImage:
            'https://i.pinimg.com/236x/7d/12/7f/7d127f891bb95989fdf63d09ed29a611.jpg'),
    StoryModel(
        image:
            'https://i.pinimg.com/564x/4d/d6/b8/4dd6b87b7fba7448edc64656223482a9.jpg',
        text: 'Ahmed Ellaban',
        profileImage:
            'https://i.pinimg.com/236x/31/1d/a4/311da4fde81b93ce4fe90b27e394c9bc.jpg'),
    StoryModel(
        image:
            'https://letsenhance.io/static/334225cab5be263aad8e3894809594ce/75c5a/MainAfter.jpg',
        text: 'Youssef Salah',
        profileImage:
            'https://i.pinimg.com/236x/9a/fd/d3/9afdd3b972e92f1f8dafea0413aba440.jpg'),
    StoryModel(
        image:
    ...
    StoryModel(
        ...
        text: 'Nourhan Gad',
        profileImage:
            'https://i.pinimg.com/236x/d2/4c/03/d24c03cd2801b37496f4fe6a378d32cf.jpg'),
    StoryModel(
        image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwtgJH1LYxi0WQ-JL8GIIt_4UvJDMAUFN44Q&usqp=CAU',
        text: 'Mahmoud Deif',
